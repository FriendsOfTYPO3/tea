...
# Function to write a .env file in .local
# This is read by docker-compose and vars defined here are
# used in .local/docker-compose.yml
...
read -r -d '' HELP <<EOF
Execute unit test suite and some other details.
...
Examples:
    ...
    ./.local/scripts/runTests.sh
    # Run unit tests using PHP 7.3
    ./.local/scripts/runTests.sh -p 7.3
EOF
